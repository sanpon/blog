...
<div class="dashboard" id="container">
    ...
    <div class="item-box">
        <h1 class="box-title clear">
            <span>最新文章</span>
            <a href="<?= Url::to(['/article/default/index']) ?>" class="right">更多<i
                        class="icon icon-double-right-arrow"></i></a>
        </h1>
        <ul class="box-content box-list">
            <?php if (empty($recent)) : ?>
                <li class="text-danger">这个家伙很懒,最近一周都没有发布文章</li>
            <?php else : ?>
                <?php foreach ($recent as $r) : ?>
                    <li class="clear">
                        [<span class="text-danger article-tag"><?= $r['name'] ?></span>]
                        <?= Article::getFrontUrl($r['title'], ['article/default/detail', 'id' => $r['id']]) ?>
    ...
    <div class="item-box">
        <h1 class="box-title">
            <span>最新留言</span>
            <a href="#" class="right">更多<i class="icon icon-double-right-arrow"></i></a>
        </h1>
        <ul class="box-content box-list">
            <li>
                <a href="#">张三:为什么用楼主的代码没有实现相同的...</a>
                <span class="text-warning right">2017.02.01</span>
            </li>
            <li>
                <a href="#">bang:javascript数组操作方式"留言:为什么用楼主的代码没有实现相同的...</a>
                <span class="text-warning right">2017.02.03</span>
            </li>
