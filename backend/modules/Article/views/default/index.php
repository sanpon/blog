 ...
 * 博文管理页面
 * @author pawn
 * @var \vendor\toolkit\library\Page $article 文章数据
...
<div class="article">
    <div class="controller clear">
        ...
        <ul class="publish clear">
            ...
            <li><a href="<?= Url::to(['default/create']) ?>" class="btn btn-primary">发布文章</a></li>
        </ul>
    </div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left">
                    <?= Article::getFrontUrl($item['title'], ['article/default/detail', 'id'=>$item['article_id']]) ?>
                </td>
                <td><?= $item['cate'] ?></td>
                <td><?= $item['keywords'] ?></td>
                <td><?= $item['username'] ?></td>
